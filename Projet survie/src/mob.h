...
void update_position_collisions(std::vector<Bullet> &bullets,std::vector<Mob>&zombies,Perso &joueur,sf::Clock &InvicibleClock,weapon arme,std::vector<Bullet> &witch_balls );
