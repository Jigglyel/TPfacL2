...
{
    mec.loadFromFile("../../mec.png");
    feu.loadFromFile("../../feu_de_camp.png");
    bank.loadFromFile("../../bank.png");
...
void jeu(Perso joueur)
{
    ...
    bank.x=100;
    bank.y=100;
    bool z=false,q=false,s=false,d=false,souris_pressee=false;
